    ...
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a href="{{ route('teacher.tasmeeh') }}"
                ...
                <flux:heading size="md" class="group-hover:text-indigo-600   s">{{ __('التسميع اليومي') }}
                </flux:heading>
            ...
            <a href="{{ route('teacher.plan-creator') }}"
                ...
                <flux:heading size="md" class="group-hover:text-indigo-600   s">{{ __('منشئ الخطط') }}</flux:heading>
            ...
            <a href="{{ route('teacher.students') }}"
                ...
                <flux:heading size="md" class="group-hover:text-indigo-600   s">{{ __('طلابي') }}</flux:heading>
