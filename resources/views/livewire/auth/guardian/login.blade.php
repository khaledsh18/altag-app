<div class="flex flex-col gap-6" dir="rtl">
    <x-auth-header :title="'تسجيل الدخول كـ ولي أمر'" :description="__('أدخل بريدك الإلكتروني وكلمة المرور للمتابعة')" />
    ...
    {{-- <div class="space-x-1 text-sm text-center rtl:space-x-reverse text-zinc-600 dark:text-zinc-400">
        ...
        <flux:link :href="route('parent.register')" wire:navigate>{{ __('تسجيل حساب جديد') }}</flux:link>
    </div> --}}
</div>